...
// context must be started before we can send messages
        ...
        ToDoItem item1 = new ToDoItem("item1", "description", true);
        ToDoItem item2 = new ToDoItem("item2", "description", false);

        producer.sendBody("jms:queue:items", item1);
        producer.sendBody("jms:queue:items", item2);
    }
